  ...
  function mockGetStore() {
    axios
      ...
      .then(function (response) {
        shopName = response.data.result[0].credentials.name;
          ...
          <div class="post-author d-flex align-items-center">
            ...
            <div>
              ...
              <div class="social-links">
                <a href="https://twitters.com/#"><i class="bi bi-twitter" /></a>
                <a href="https://facebook.com/#"><i class="bi bi-facebook" /></a
                >
                <a href="https://instagram.com/#"
                  ><i class="biu bi-instagram" /></a
                >
              </div>
              <p>
